...
| Game Boy                            | `GB`         | [GBC.emu](https://www.explusalpha.com/)                                                  |                                                                  :material-android:{ .android } |
| Game Boy                            | `GB`         | [My OldBoy!](https://play.google.com/store/apps/details?id=com.fastemulator.gbc)         |                                                                  :material-android:{ .android } |
| Game Boy                            | `GB`         | [Pizza Boy GBC](https://www.dbtecno.it/)                                                 |                                     :material-android:{ .android } :material-trophy:{ .trophy } |
...
| Game Boy Color                      | `GBC`        | [GBC.emu](https://www.explusalpha.com/)                                                  |                                                                  :material-android:{ .android } |
| Game Boy Color                      | `GBC`        | [My OldBoy!](https://play.google.com/store/apps/details?id=com.fastemulator.gbc)         |                                                                  :material-android:{ .android } |
| Game Boy Color                      | `GBC`        | [Pizza Boy GBC](https://www.dbtecno.it/)                                                 |                                     :material-android:{ .android } :material-trophy:{ .trophy } |
...
| Super Nintendo Entertainment System | `SNES`       | [Snes9x EX+](https://www.explusalpha.com/)                                               |                                                                  :material-android:{ .android } |
...
| Game Boy Advance                    | `GBA`        | [GBA.emu](https://www.explusalpha.com/)                                                  |                                                                  :material-android:{ .android } |
| Game Boy Advance                    | `GBA`        | [My Boy!](https://play.google.com/store/apps/details?id=com.fastemulator.gba)            |                                                                  :material-android:{ .android } |
| Game Boy Advance                    | `GBA`        | [Pizza Boy GBA](https://www.dbtecno.it/)                                                 |                                     :material-android:{ .android } :material-trophy:{ .trophy } |
...
| Master System | `SMS`    | [MD.emu](https://www.explusalpha.com/)                                                             |                                                                  :material-android:{ .android } |
| Master System | `SMS`    | [MasterGear](https://fms.komkon.org/MG/)                                                           |                                                                  :material-android:{ .android } |
...
| PC Engine            | `PCE`        | [PCE.emu](https://www.explusalpha.com/) |                                                                  :material-android:{ .android } |
...
| Neo Geo Pocket       | `NGP`    | [NGP.emu](https://www.explusalpha.com/) |                                                                  :material-android:{ .android } |
...
| WonderSwan       | `WS`   | [Swan.emu](https://www.explusalpha.com/) |                                                                  :material-android:{ .android } |
| WonderSwan Color | `WSC`  | `mednafen_wswan`                         | :material-check-bold:{ .shipped } :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| WonderSwan Color | `WSC`  | [Swan.emu](https://www.explusalpha.com/) |                                                                  :material-android:{ .android } |

### Arcade

| Platform       | Folder | Core / App      |                                                                                                 |
|----------------|--------|-----------------|------------------------------------------------------------------------------------------------:|
| Arcade (MAME)  | `MAME` | `mame2003_plus` | :material-check-bold:{ .shipped } :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| Arcade (MAME)  | `MAME` | `mame`          |                                   :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| Arcade (MAME)  | `MAME` | `mame2000`      |                                   :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| Arcade (MAME)  | `MAME` | `mame2003`      |                                   :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| Arcade (MAME)  | `MAME` | `mame2010`      |                                   :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
| Arcade (FBNeo) | `FBN`  | `fbneo`         | :material-check-bold:{ .shipped } :custom-retroarch:{ .retroarch } :material-trophy:{ .trophy } |
