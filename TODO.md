...
- [ ] Three-tier override system explanation (global → platform → game)
- [ ] OSD messages documentation (fast forward, shader cycling, achievement unlocks)
- [ ] FAQ expansion (compressed ROMs, overlays, shaders, low latency, renderer)
